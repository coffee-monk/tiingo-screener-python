# import pandas as pd
#
# def SMA_above(df, sma_periods=[50, 200], distance_pct=None):
#     """
#     Detect when price is above moving averages, optionally within max distance.
#    
#     Parameters:
#         - df: DataFrame with price and SMA columns
#         - sma_periods: List of SMA periods to check
#         - distance_pct: Optional max % distance above SMA to consider
#        
#     Returns:
...
#             distance_pct = ((latest['Close'] - latest[sma_col]) / latest['Close']) * 100
#            
