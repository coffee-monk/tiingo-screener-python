...
def OB_bearish_resistance(df):
    """
    Returns: 
        pd.DataFrame: Single-row DataFrame of the most recent bearish OB if price is in range,
    ...
    # Search backward for most recent bearish OB
