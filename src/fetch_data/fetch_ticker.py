...
def fetch_ticker(timeframe='daily', ticker='BTCUSD', start_date=None, end_date=None, api_key='Tiingo-API-Key'):
    ...
    timeframe_config = {
        ...
        'hourly':    {'resampleFreq':  '1hour', 'default_timedelta': timedelta(hours=10000)},
        'hour':      {'resampleFreq':  '1hour', 'default_timedelta': timedelta(hours=10000)},
        '1hour':     {'resampleFreq':  '1hour', 'default_timedelta': timedelta(hours=10000)},
        'h':         {'resampleFreq':  '1hour', 'default_timedelta': timedelta(hours=10000)},
