...
def calculate_candle_colors(df, default_color='banker_RSI'):
    ...
    def map_banker_RSI(banker_RSI):
        ...
        elif   0 == banker_RSI:         return colors['black']
    ...
    def map_QQEMOD(df):
        if df['QQE1_Above_Upper'] and df['QQE2_Above_Threshold']:
            return colors['teal'] if df['QQE2_Above_TL'] else colors['teal_trans_3']
        elif df['QQE1_Below_Lower'] and df['QQE2_Below_Threshold']:
            return colors['red'] if not df['QQE2_Above_TL'] else colors['red_trans_3']

        elif df['QQE2_Above_Threshold']: return colors['teal_trans_1']  
