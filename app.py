...
def vis(scan_file=None, ticker=None):
    ...
    if not scan_file:
        ...
        df222 = fetch_ticker(timeframe='d',  ticker=ticker, api_key=API_KEY)
        df2222 = fetch_ticker(timeframe='d',  ticker=ticker, api_key=API_KEY)
        ...
        df22 = get_indicators(df22, indicators['daily_2'], params['daily_2'])
        df222 = get_indicators(df222, indicators['daily_3'], params['daily_3'])
        df2222 = get_indicators(df2222, indicators['daily_4'], params['daily_4'])
