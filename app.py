...
ticker = 'BTCUSD' ; start_date = '2023-11-11'
...
df1 = get_indicators(df1, ['candle_colors', 'SMA', 'OB'], {'OB': {'periods': 10}})
# df2 = get_indicators(df2, ['candle_colors', 'SMA'])
# df3 = get_indicators(df3, ['candle_colors', 'SMA'])
# df4 = get_indicators(df4, ['candle_colors', 'SMA'])
